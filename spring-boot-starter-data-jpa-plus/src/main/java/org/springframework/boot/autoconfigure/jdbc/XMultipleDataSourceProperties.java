...
/**
 * {@link XDataSourceProperties} for multiple
 */
@ConfigurationProperties(XDataSourceProperties.PREFIX)
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class XMultipleDataSourceProperties extends XDataSourceProperties {
	 ...
	 * Multiple
	 */
	private Map<String, XDataSourceProperties> multiple = new HashMap<>();
