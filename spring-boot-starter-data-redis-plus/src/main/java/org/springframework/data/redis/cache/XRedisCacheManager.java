...
public class XRedisCacheManager extends RedisCacheManager {
	 ...
	 */
	public XRedisCacheManager(@NonNull RedisCacheManager sourceCacheManager) {
	 ...
	 */
	public XRedisCacheManager(@NonNull RedisCacheManager sourceCacheManager, RedisCacheWriter cacheWriter) {
	 ...
	 * @return {@link XRedisCacheManager}
	 */
	public XRedisCacheManager setDynamicCacheConfiguration(String name, RedisCacheConfiguration cacheConfig) {
