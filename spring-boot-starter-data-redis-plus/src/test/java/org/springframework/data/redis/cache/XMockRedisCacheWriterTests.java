...
/**
 * Tests for {@link XMockRedisCacheWriter}
 */
public class XMockRedisCacheWriterTests {
	...
	/**
	 * {@link XMockRedisCacheWriter}
	 */
	private XMockRedisCacheWriter cacheWriter;
	...
	public void before() {
		...
		this.cacheWriter = new XMockRedisCacheWriter(new LettuceConnectionFactory());
	}
	
	/**
	 * {@link XMockRedisCacheWriter#get(String, byte[])}
	 */
	@Test
	public void get() {
	...
	/**
	 * {@link XMockRedisCacheWriter#put(String, byte[], byte[], Duration)}
	 */
	public void put() {
	...
	/**
	 * {@link XMockRedisCacheWriter#putIfAbsent(String, byte[], byte[], Duration)}
	 */
	...
	/**
	 * {@link XMockRedisCacheWriter#remove(String, byte[])}
	 */
	@Test
	public void evict() {
	...
	/**
	 * {@link XMockRedisCacheWriter#clean(String, byte[])}
	 */
	@Test
	public void clean() {
