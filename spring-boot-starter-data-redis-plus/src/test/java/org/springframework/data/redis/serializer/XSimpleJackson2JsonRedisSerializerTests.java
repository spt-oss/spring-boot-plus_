...
/**
 * Tests for {@link XSimpleJackson2JsonRedisSerializer}
 */
public class XSimpleJackson2JsonRedisSerializerTests {
	...
	/**
	 * {@link XSimpleJackson2JsonRedisSerializer}
	 */
	private XSimpleJackson2JsonRedisSerializer serializer;
	...
	public void before() {
		...
		XSimpleJackson2JsonRedisSerializer serializer = new XSimpleJackson2JsonRedisSerializer(new ObjectMapper()
		/* @formatter:off */
			.registerModules(
	...
	/**
	 * {@link XSimpleJackson2JsonRedisSerializer#setIgnoreDeserializationError(boolean)}
	 */
	@Test
	...
	/**
	 * {@link XSimpleJackson2JsonRedisSerializer#serialize(Object)}
	 */
	@Test
	...
	/**
	 * {@link XSimpleJackson2JsonRedisSerializer#deserialize(byte[])}
	 */
	@Test
	public void deserialize() {
		
		String string = XSimpleJackson2JsonRedisSerializerTests.class.getSimpleName() + "."
