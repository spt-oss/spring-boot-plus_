...
/**
 * {@link Test}: {@link CustomRedisAutoConfiguration} with Lettuce
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = CustomRedisAutoConfiguration.class)
@ActiveProfiles({ "test", "test-redis-config-with-lettuce" })
public class CustomRedisAutoConfigurationWithLettuceTests {
	...
	/**
	 * {@link CustomLettuceConnectionConfiguration#redisConnectionFactory(io.lettuce.core.resource.ClientResources)}
	 */
	@Test
