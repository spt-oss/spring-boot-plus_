...
/**
 * {@link Test}: {@link RedisKeyGenerator}
 */
public class RedisKeyGeneratorTests {
	
	/**
	 * {@link RedisKeyGenerator}
	 */
	private RedisKeyGenerator keyGenerator = new RedisKeyGenerator();
	
	/**
	 * {@link RedisKeyGenerator#generate(Object, Method, Object...)}
	 */
	@Test
	...
	protected static class TestService {
		...
		/* @formatter:off */
			String first,
			@CacheParam(required = false) int second,
			boolean third) {
			/* @formatter:on */
