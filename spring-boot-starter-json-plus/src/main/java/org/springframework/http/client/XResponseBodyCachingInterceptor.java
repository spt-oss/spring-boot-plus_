...
/**
 * {@link ClientHttpRequestInterceptor} for {@link XBodyCachingClientHttpResponse}
 */
...
public class XResponseBodyCachingInterceptor implements ClientHttpRequestInterceptor {
	...
	public ClientHttpResponse intercept(HttpRequest request, byte[] body, @NonNull ClientHttpRequestExecution execution)
		...
		if (response instanceof XBodyCachingClientHttpResponse) {
			
			return response;
		}
		
		return new XBodyCachingClientHttpResponse(response);
	}
}
